  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 relative">
      <div className="container mx-auto text-center max-w-5xl relative">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-serif font-bold mb-6 text-slate-900 dark:bg-gradient-to-r dark:from-purple-500 dark:via-teal-500 dark:to-blue-500 dark:bg-clip-text dark:text-transparent dark:animate-gradient tracking-tight">
            João Paulo Pereira
          </h1>
          
          <motion.div
            className="text-xl md:text-2xl text-gray-700 dark:text-gray-300 mb-6 font-light leading-relaxed"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <p className="text-base md:text-lg text-gray-700 dark:text-gray-300 leading-relaxed border-l-2 border-slate-900 dark:border-purple-500 pl-4 text-left">
              {t('home.intro.line1')}<br />
              {t('home.intro.line2')}
            </p>
            
            <p className="text-sm md:text-base text-gray-700 dark:text-gray-300 leading-relaxed text-left">
          ...
          >
            ...
            <Link
              href="/sobre"
              className="px-8 py-3 border-2 border-slate-900 dark:border-purple-500 text-slate-900 dark:text-purple-500 rounded-full font-medium hover:bg-slate-900 dark:hover:bg-purple-500/90 hover:text-white dark:hover:text-white transition-colors duration-300 glass"
            >
              {t('home.cta.about')}
            </Link>
          </motion.div>
          ...
          {/* Seção de Contato */}
          <motion.div
            className="mt-16 pt-12 border-t border-slate-900/10 dark:border-white/10"
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.9, duration: 0.8 }}
          >
            <h2 className="text-2xl md:text-3xl font-serif font-bold mb-4 text-slate-900 dark:bg-gradient-to-r dark:from-purple-500 dark:to-teal-500 dark:bg-clip-text dark:text-transparent tracking-tight">
              {t('home.contact.title')}
            </h2>
            <p className="text-sm md:text-base text-gray-700 dark:text-gray-300 mb-6 max-w-2xl mx-auto">
