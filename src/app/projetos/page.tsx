  ...
  return (
    <div className="min-h-screen py-24 px-6">
      <div className="container mx-auto max-w-6xl">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-serif font-bold mb-4 text-slate-900 dark:bg-gradient-to-r dark:from-purple-500 dark:to-teal-500 dark:bg-clip-text dark:text-transparent tracking-tight">
            {t('projects.title')}
          </h1>
          ...
          {filteredProjetos.map((projeto, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Contexto */}
                <div className="mb-6 border-l-2 border-slate-900/15 dark:border-gray-600/30 pl-4 relative z-10">
                  <h3 className="text-xs font-semibold text-slate-700 dark:text-gray-300 uppercase tracking-wider mb-1.5">
                    {t('projects.context')}
                  </h3>
                ...
                <div className={`p-4 bg-gradient-to-br ${config.card} dark:to-transparent rounded-xl border relative z-10 group/impact`}>
                  ...
                  <h3 className="text-xs font-semibold text-slate-700 dark:text-gray-300 uppercase tracking-wider mb-1.5 relative z-10">
                    {t('projects.impact')}
                  </h3>
                ...
                {(projeto.link || projeto.repositorio) && (
                  <div className="mt-5 pt-5 border-t border-slate-900/10 dark:border-white/10 relative z-10">
